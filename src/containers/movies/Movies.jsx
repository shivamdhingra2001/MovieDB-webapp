...
import LeftListBar from '../../components/leftlistbar/LeftListBar';
    ...
    return (
        <main className='homePage'>
            <Container>
                ...
                <Row>
                    <Col className='col-2'>
                        <LeftListBar genres={genres} selectedGenres={selectedGenres} setSelectedGenres={setSelectedGenres}  setGenres={setGenres} type="movie" setPage={setPageno}/> 
                    </Col>
                    <Col className='col-10'>
                        <Row>
                                {
                                    content && content.length > 0 ? content.map((item, index)=>{
                                        return (<CardMovies key={index} data={item} mediaType="movie"/>)
                                    }) : 'Loading ....'
                                }
